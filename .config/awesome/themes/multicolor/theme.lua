...
theme.weather = lain.widget.weather({
    city_id = 2643743, -- placeholder (Barcelona)
...
theme.mpd = lain.widget.mpd({
    settings = function()
        ...
        widget:set_markup(markup.fontfg("Terminus 10", "#e54c62", artist) .. markup.fontfg("Terminus 10", "#b2b2b2", title))
    end
})
...
function theme.at_screen_connect(s)
    ...
    s.mylayoutbox:buttons(my_table.join(
                           ...
                           awful.button({}, 0, function () awful.layout.inc(-1) end)
    ))
